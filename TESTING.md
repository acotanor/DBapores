...
| TC-007 | Recomendaciones sin API Key configurada | API/Negativa | GET /api/recommend?steamId=<steamId válido> con `STEAM_API_KEY` predeterminada | Responde 500 con error de configuración de API Key. | Manual |
